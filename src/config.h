...
#define CFG_KEY_MUTE       "key_mute"
#define CFG_KEY_SAVE_STATE "key_save_state"
#define CFG_KEY_LOAD_STATE "key_load_state"
#define CFG_KEY_REWIND     "key_rewind"
#define CFG_KEY_FAST_MODE  "key_fast_mode"
#define CFG_KEY_SLOW_MODE  "key_slow_mode"
